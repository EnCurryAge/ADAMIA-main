...
def parse_args():
    ...
    # ======================== Load Target Encoder =========================
    parser.add_argument('--target_encoder_path', type=str, default='./pretrained_encoders/'
...
def get_csv(num1=100, num2=100, root='./logging/GenInferenceData.xlsx'):
    ...
    ex.to_csv('./logging/GenInferenceData.csv', encoding='gbk', sep=',', index=False)
