...
# with open("../logging/test.txt", "a") as b:
#     b.truncate(0)
# with open("../logging/loss.txt", "a") as c:
#     c.truncate(0)
# with open("../logging/results.txt", "a") as d:
#     d.truncate(0)


# load dataset:
BATCH_SIZE = args.batch_size
dataset = np.loadtxt('../logging/GenInferenceData.csv', delimiter=",")
...
def ADA_MIA(e=args.inference_epochs, sign=True):
    ...
    for epoch in range(0, e):
        ...
        a, p, r, f = train(train_dataloader, attack_model, criterion, 100, LR=0.00075)
        if a > aa:
            aa, pp, rr, ff = a, p, r, f
